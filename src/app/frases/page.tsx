...
import { getQuoteData, getCategoriesFromQuotes, Quote } from '@/lib/dados';
...
export default function FrasesPage({ isCategorySheetOpen, setIsCategorySheetOpen }: HomePageProps) {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const { quotes: loadedQuotes } = await getQuoteData();
        const { mainCategories, subCategoriesByMain } = getCategoriesFromQuotes(loadedQuotes);
        setQuotes(loadedQuotes);
        setMainCategories(mainCategories);
        setSubCategories(subCategoriesByMain);
      } catch (error) {
  ...
  }, [searchTerm, selectedMainCategory, selectedSubCategory, quotes]);
    ...
    <>
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto py-8 px-4">
          ...
          <div className="hidden md:flex flex-col md:flex-row gap-4 mb-8 items-center">
